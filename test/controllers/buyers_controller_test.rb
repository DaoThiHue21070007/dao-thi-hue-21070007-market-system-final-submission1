...
class BuyersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buyer" do
    assert_difference("Buyer.count") do
      post buyers_url, params: { buyer: { classification: @buyer.classification, feature: @buyer.feature, name: @buyer.name, product_id: @buyer.product_id } }
    end
  ...
  test "should update buyer" do
    patch buyer_url(@buyer), params: { buyer: { classification: @buyer.classification, feature: @buyer.feature, name: @buyer.name, product_id: @buyer.product_id } }
